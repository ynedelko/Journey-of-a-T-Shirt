...
visitors = Visitor.create([{ name: 'Ann', :guess 'China', tshirt_made: 'China', comment:'woah!'}, { name: 'Bob', , guess: 'China', tshirt_made: 'India', comment:'interesting' }, { name: 'Chris', tshirt_made: 'China', comment:'I give away a lot of my clothes.' }, { name: 'Emily', :guess 'China', tshirt_made: 'China', comment:'my clothes are very inexpensive' }, { name: 'Joy', :guess 'India', tshirt_made: 'Hand-Made', comment:'my mom made this T.' }])
