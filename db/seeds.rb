...
visitors = Visitor.create([{ name: 'Ann', tshirt_made: 'China', comment:'woah!' }, { name: 'Bob', tshirt_made: 'India', comment:'interesting' }, { name: 'Chris', tshirt_made: 'China', comment:'I give away a lot of my clothes.' }, { name: 'Emily', tshirt_made: 'China', comment:'my clothes are very inexpensive' }, { name: 'Joy', tshirt_made: 'Hand-Made', comment:'my mom made this T.' }])
